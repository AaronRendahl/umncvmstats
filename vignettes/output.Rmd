...
You can use any `gt` function by first doing this conversion yourself using `as_gt`. The following table looks the same because I haven't added any other functions yet.

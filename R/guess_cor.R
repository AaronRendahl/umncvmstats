...
#'
#'
#' @param seed the random seed used in creating the data.
#' @param nonp should non-parametric correlations be shown?
#' @param skew should extra skew be randomly added?
#' @param rank should the data set be converted to ranks before plotting and computing correlations?
#' @param answer option to control interactivity; options are "`interactive`", "`show`", and "`hide`".
#' @param return.data normally the plot is returned; if TRUE, the data is returned instead.
#'
#' @export
